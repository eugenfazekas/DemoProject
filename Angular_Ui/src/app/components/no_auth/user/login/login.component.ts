...
export class LoginComponent {
  ...
  constructor(private authService: AuthService, private router: Router, 
              private formBuilder: FormBuilder, private logservice: LogService, private userRepositry: UserRepository, private loggedUserService: LoggedUserService, ) {
    ...
    if(this.loginForm.valid) {
      ...
      this.authService.loginUser(this.email, this.loginForm.controls['password'].value).subscribe(
            res =>  {  
                      ...
                      this.userRepositry.userRestDataGetUser().subscribe(                           
                              res => {  
                                 res != null ? this.loggedUserService.setLoggedIn(true) : null; 
                                 if(res.firstName != null) {
                                 this.loggedUserService.setUser(res)}; 
                                 this.userRepositry.setUser(res)
